...
import com.example.gameonquiz.databinding.ActivityRugbyQuizBinding
import com.example.gameonquiz.models.RugbyConstants.allQuestions
import com.example.gameonquiz.models.RugbyConstants.getAllQuestions

class RugbyQuizActivity : AppCompatActivity() {

    private lateinit var binding: ActivityRugbyQuizBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRugbyQuizBinding.inflate(layoutInflater)
        ...
        binding.btnNext.setOnClickListener {
            ...
            if (selectedAnswer != -1) {
                ...
                if (questionNumber == listOfQuestions.count()) {
                    ...
                    intent.putExtra("category", "Rugby")
