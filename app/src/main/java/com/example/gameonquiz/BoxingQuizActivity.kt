...
import com.example.gameonquiz.databinding.ActivityBoxingQuizBinding
import com.example.gameonquiz.models.BoxingConstants.allQuestions
import com.example.gameonquiz.models.BoxingConstants.getAllQuestions

class BoxingQuizActivity : AppCompatActivity() {

    private lateinit var binding: ActivityBoxingQuizBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityBoxingQuizBinding.inflate(layoutInflater)
        ...
        binding.btnNext.setOnClickListener {
            ...
            if (selectedAnswer != -1) {
                ...
                if (questionNumber == listOfQuestions.count()) {
                    ...
                    intent.putExtra("category", "Boxing")
