...
import com.example.gameonquiz.databinding.ActivityBasketballQuizBinding
...
class BasketballQuizActivity : AppCompatActivity() {

    private lateinit var binding: ActivityBasketballQuizBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityBasketballQuizBinding.inflate(layoutInflater)
